...
- Quando o destino da automacao e `Contato`, os contatos selecionados aparecem em uma lista minimalista abaixo do campo, com acao discreta de remocao por item.
