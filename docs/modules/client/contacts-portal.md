...
- Formulario unico para salvar ou complementar nome, empresa, e-mail e telefone
- Edicao inline de nome, empresa, e-mail e telefone na propria listagem
...
- O formulario aceita todos os campos vazios, porque o backend trata nome, empresa, e-mail e telefone como opcionais.
- Se o e-mail ou telefone ja existir, o salvamento complementa o contato existente.
- Cada linha da listagem pode entrar em modo de edicao inline para alterar os quatro campos sem sair da pagina.
...
- A busca filtra por nome, empresa, e-mail ou telefone.
